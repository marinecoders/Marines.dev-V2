...
<div class="publication-page">
  ...
  <div
    ...
    class="lg:hidden fixed inset-0 bg-black bg-opacity-50 z-40 transition-opacity duration-300 ease-in-out"
  ...
  <div class="max-w-[1400px] mx-auto px-2 sm:px-4 lg:px-6 py-16">
    <div class="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-6 lg:gap-8 min-h-screen lg:-ml-16">
      ...
      <main class="main-content">
        ...
        <!-- Disclaimer -->
        <div class="bg-red-600 dark:bg-red-900 border border-red-500 dark:border-red-600 p-6 mb-8 transition-colors duration-200">
          <h2 class="text-xl font-bold text-white dark:text-red-200 mb-4">DISCLAIMER</h2>
          <p class="text-white dark:text-white">
            This is not an official USMC publication. This is meant for internal use within the Marine Coders team and throughout the broader Marine Innovation Unit as necessary.
          </p>
        </div>
        ...
        <!-- Forward -->
        <section class="mb-16">
          <div class=" border-l-4 border-mcswf-gold p-6 mb-6">
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2 mb-4">
              ...
              <li>• The use of unmanned aerial vehicles (UAVs), robotic ground systems, and AI-powered decision support tools is increasing</li>
            </ul>
          </div>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              <div class="chapter-title">Mission, Vision, and Core Values</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6">
            ...
            <div class="space-y-6 text-black dark:text-white">
              ...
              <div>
                ...
                <p class="italic text-gray-600 dark:text-gray-300">We measure success not in features delivered, but in capability gained by the warfighter.</p>
              </div>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              <div class="chapter-title">Marine Coders Organization and Structure</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <p class="text-black dark:text-white mb-4">
              ...
              that development efforts can be staffed by select persons within administrative teams, or across administrative teams, depending on the specific skillsets needed.
            </p>
          </div>
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <ul class="text-black dark:text-white space-y-1 ml-4">
                  ...
                  <li>• Ensuring compatibility with other DoD systems</li>
                </ul>
              </div>
            ...
            <div class="space-y-4 text-black dark:text-white">
              <div>
                ...
                <p>
                  ...
                  practices. Their leadership enables reliable delivery in support of mission objectives. They lead the team and are ultimately responsible for mission success.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  focused, agile, and responsive to the evolving needs of the warfighter.
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              <div class="chapter-title">Marine Coders Operating Model</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Internal Training & Upskilling – Marines can enhance their technical skills and transition into software development roles within MIU.</li>
            </ul>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <p class="text-black dark:text-white">
              ...
              Additionally, structured, on-the-job cross-training during one-week offsite IDT events or AT sessions provide extra opportunities for targeted upskilling. This flexible approach will
              enable Marines to develop versatility, close skill gaps efficiently, and proactively align capabilities with mission requirements.
            </p>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2 mb-4">
              ...
              <li>
                • One day a month unit calls and training (24 points) - Each month, the MIU hosts an all-hands call. The Marine Coders hosts training on these days as well, allowing participants to
                earn two points
              </li>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2 mb-4">
              ...
              <li>
                • Cross-Team Collaboration – Marine Coders act as technical resources to active-duty Marines at MCSWF, supporting them in modern software development, DevSecOps, and AI-driven
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              <div class="chapter-title">Impact and Future Operations</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2 mb-4">
              ...
              <li>
                • <strong>Platform Development and Application Hosting</strong> – Contributing to the development of a secure, Marine Corps-owned digital platform capable of hosting applications across
                classification levels and deployment environments. This foundational capability is critical to ensuring that Marine-developed software can be fielded rapidly, securely, and independently
                of enterprise constraints, supporting true agility and digital self-sufficiency
              </li>
            </ul>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              <div class="chapter-title">Technical Manager Billet Description</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Provide technical mentorship and guidance to fellow developers and cross-functional teammates</li>
              <li>• Collaborate with product managers, UX designers, and end users to refine requirements and deliver impactful solutions</li>
              <li>• Support the integration of Marine Coders-developed software into operational workflows and Marine Corps platforms, including TAK and edge-deployable systems</li>
              <li>• Participate in agile development practices, including sprint planning, backlog grooming, and retrospectives</li>
              <li>• Maintain current knowledge of software engineering practices, DoD cyber requirements, and emerging technologies</li>
            </ul>
          </div>
          ...
          <div class=" p-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Experience with TAK plugin development, secure mobile or edge computing applications, and geospatial data formats (GeoPackage, KML, MBTiles)</li>
              <li>• Familiarity with DevSecOps principles, CI/CD pipeline management, and infrastructure-as-code tools</li>
              <li>• Strong communication skills and the ability to translate between technical and operational stakeholders</li>
            </ul>
          </div>
        </section>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              class="clickable-header">
              <div class="chapter-number">Appendix</div>
              <div class="chapter-title">Software Engineer Billet Description</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Collaborate with active duty and Reserve components to understand operational requirements and translate them into functional software</li>
              <li>• Conduct testing, debugging, documentation, and deployment of software solutions</li>
              <li>• Continuously train to remain proficient in relevant technologies and software development practices</li>
            </ul>
          </div>
          ...
          <div class=" p-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Ability to work independently and as part of a remote, distributed team</li>
              <li>• DevSecOps expertise</li>
            </ul>
          </div>
        </section>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              class="clickable-header">
              <div class="chapter-number">Appendix</div>
              <div class="chapter-title">Data Scientist/AI Engineer (Data) Billet Description</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Create intuitive data visualizations, dashboards, and decision aids using tools like Power BI, Tableau, Plotly, or open-source libraries</li>
              <li>• Collaborate with end users to translate operational challenges into analytical questions and actionable outputs</li>
              <li>• Integrate with software development teams (e.g., Marine Coders) to embed analytics and models into functional applications</li>
              <li>• Stay abreast of emerging trends in data science, AI/ML, and DoD data initiatives (e.g., JADC2, Project Maven, ADVANA)</li>
            </ul>
          </div>
          ...
          <div class=" p-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Ability to analyze and work with structured and unstructured military data sets, including logistics, intelligence, and personnel data</li>
              <li>• Prior experience in military operations, operations research, or supporting decision-making with data is highly desirable</li>
            </ul>
          </div>
        </section>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              class="clickable-header">
              <div class="chapter-number">Appendix</div>
              <div class="chapter-title">Design Strategist Billet Description</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Create user personas, journey maps, task flows, and other UX artifacts to communicate findings and design direction</li>
              <li>• Validate design concepts and prototypes through iterative testing with representative users</li>
              <li>• Advocate for accessibility, usability, and mission effectiveness in all user-facing aspects of the application</li>
              <li>• Contribute to the creation of style guides and interface standards to ensure consistent and user-friendly experiences</li>
            </ul>
          </div>
          ...
          <div class=" p-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Ability to produce clear research documentation and communicate insights to technical and non-technical audiences</li>
              <li>• Understanding of agile software development and working within cross-functional teams</li>
              <li>• Experience designing for users in complex or high-stakes environments (e.g., military, medical, industrial)</li>
              <li>• Strong interpersonal skills and the ability to build trust and rapport with end users and stakeholders</li>
              <li>• Self-directed and able to contribute meaningfully in a distributed, asynchronous work environment</li>
            </ul>
          </div>
        </section>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              class="clickable-header">
              <div class="chapter-number">Appendix</div>
              <div class="chapter-title">Product Manager (PM) Billet Description</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6 mb-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Coordinate closely with developers, UX researchers, designers, and data analysts to ensure cohesive product delivery</li>
              <li>• Gather and synthesize user feedback to inform product direction and ongoing iteration</li>
              <li>• Communicate product vision and progress to stakeholders, both technical and operational</li>
              <li>• Manage scope, timelines, and prioritization to ensure delivery of mission-relevant outcomes</li>
              <li>• Maintain awareness of Marine Corps modernization efforts and digital priorities to inform product strategy</li>
            </ul>
          </div>
          ...
          <div class=" p-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Understanding of software development processes, technical architecture, and design constraints</li>
              <li>• Experience working directly with military end users or in support of operational units</li>
              <li>• Ability to communicate effectively across technical and non-technical audiences</li>
              <li>• Demonstrated ability to manage competing priorities and deliver results in resource-constrained environments</li>
            </ul>
          </div>
        </section>
        ...
        <section
          ...
          <div class="chapter-header">
            ...
            <a
              ...
              class="clickable-header">
              <div class="chapter-number">Appendix</div>
              <div class="chapter-title">Core Skills for All Marine Coders</div>
            </a>
            <div class="electric-line"></div>
          </div>
          ...
          <div class=" p-6">
            ...
            <ul class="text-black dark:text-white space-y-2">
              ...
              <li>• Common team communication tools (e.g., Slack, Microsoft Teams, Discord, Matrix)</li>
            </ul>
          </div>
        </section>
      </main>
