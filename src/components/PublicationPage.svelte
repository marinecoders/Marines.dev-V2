      ...
      <main class="main-content">
        ...
        <section class="mb-16">
          ...
          <div class="p-6 mb-8">
            ...
            <ul class="dark:text-white space-y-2 mb-0">
        ...
        <section
          ...
          <div class="p-6 mb-8">
            ...
            <p class="dark:text-white mb-0">While specific timelines vary year-to-year, a reasonable annual timeline for the Marine Coders team is as follows:</p>
          </div>
