...
<div
  class="accordion w-full bg-mcswf-pinstripe border-mcswf-gold"
  class:rounded-t-lg={isStart}
  class:rounded-b-lg={isEnd}
  class:border-t-2={isMiddle | isEnd}>
  <button
  ...
  {#if open}
    <div
      class="details bg-white text-black text-left p-4"
      class:rounded-b-lg={isEnd}
      transition:slide>
